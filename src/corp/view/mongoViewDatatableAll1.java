...
@ManagedBean
@ViewScoped
public class mongoViewDatatableAll1 {
	private static final Logger LOGGER = Logger.getLogger(mongoViewDatatableAll1.class);
...
@PostConstruct
public void init() {
	LOGGER.info("mongoViewDatatableAll1.init()");
...
public void consultaAgenda() {
	LOGGER.info("mongoViewDatatableAll1.consultaAgenda()");
...
public void obtenerIdNext() {
	LOGGER.info("mongoViewDatatableAll1.obtenerIdNext() : ");
	
	mongoCrudAgendaDao = new MongoCrudAgendaDao();
	
	if (mongoCrudAgendaDao.ultimoID()>0) {
		respuesta=mongoCrudAgendaDao.ultimoID();
		id=respuesta;
	} else {
...
public void agregarElemento() {
	LOGGER.info("mongoViewDatatableAll1.agregarElemento() : "+selecTable+" id: "+id);
	mongoCrudAgendaDao = new MongoCrudAgendaDao();
	LOGGER.info("ID: "+id);
...
/*
public void limpiar() {
	LOGGER.info("mongoViewDatatableAll1.limpiar()");
	id=0;
	nombre="";
	heroe="";
	compania="";
...
public void verSelect() {
	LOGGER.info("mongoViewDatatableAll1.verSelect()");

}

// actualizar elemento
public void actualizar() {
	LOGGER.info("mongoViewDatatableAll1.actualizar()"+ selecTable);
...
public void eliminaElemento() {
	LOGGER.info("mongoViewDatatableAll1.eliminaElemento()");
	mongoCrudAgendaDao = new MongoCrudAgendaDao();
...
public int getId() {
	System.out.println("mongoViewDatatableAll1.getId()");
	return id;
}

public void setId(int id) {
	System.out.println("mongoViewDatatableAll1.setId()");
	this.id = id;
}
